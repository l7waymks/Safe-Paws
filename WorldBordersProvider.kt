...
object WorldBordersProvider {
    ...
    // Standard Pink Styling Palette
    val PINK_BORDER_COLOR = Color.parseColor("#FF1493")        // Deep Vivid Hot Pink
    val PINK_FILL_COLOR = Color.parseColor("#1EFF1493")          // Crystal Translucent Pink Fill
    val PINK_SELECTED_BORDER = Color.parseColor("#FF007F")      // Electric Rose Neon
    val PINK_SELECTED_FILL = Color.parseColor("#38FF1493")        // Highlighted Pink Fill
    val PINK_ACCENT = Color.parseColor("#BE185D")               // Rich Pink Dark Text
        ...
        return withContext(Dispatchers.IO) {
            ...
            try {
                ...
                val request = Request.Builder()
                    .url(url)
                    .header("User-Agent", "SafePawsGeo/4.0 (Android HighPrecision Vector Client)")
                    .build()
            ...
            if (iso3.isNotBlank()) {
                try {
                    ...
                    val gbRequest = Request.Builder()
                        .url(gbUrl)
                        .header("User-Agent", "SafePawsGeo/4.0")
                        .build()
            ...
            // Source 3: Nominatim general query fallback
            try {
    ...
    private fun parseRingCoordinates(ringArray: JSONArray): List<GeoPoint> {
        ...
        val step = if (total > 3000) (total / 2200).coerceAtLeast(1) else 1
    ...
    val countries: List<WorldCountryBorder> by lazy {
        listOf(
            // ==================== MOROCCO (المملكة المغربية الشريفة) ====================
            // Exact geographical coastline and official territorial integrity from Cap Spartel to Guerguerat & Lagouira
            run {
                val moroccoPoints = pts(
                    // Cap Spartel & Tangier Coast
                    35.792 to -5.926, 35.786 to -5.845, 35.782 to -5.808, 35.800 to -5.780, 35.811 to -5.753, 35.830 to -5.680, 35.850 to -5.560,
                    35.875 to -5.510, 35.890 to -5.480, 35.918 to -5.405, 35.900 to -5.350, 35.845 to -5.350,
                    // Bab Sebta, Fnideq, M'diq, Cabo Negro, Martil
                    35.760 to -5.330, 35.685 to -5.320, 35.680 to -5.275, 35.620 to -5.270, 35.545 to -5.240, 35.518 to -5.195,
                    // Oued Laou, Targha, Steha, Bou Ahmed, Jebha
                    35.450 to -5.100, 35.390 to -5.020, 35.350 to -4.980, 35.320 to -4.950, 35.260 to -4.800, 35.210 to -4.670, 35.190 to -4.520,
                    // Cala Iris, Torres de Alcala, Badis, Peñon de Velez
                    35.250 to -4.360, 35.240 to -4.330, 35.180 to -4.300, 35.210 to -4.100,
                    // Al Hoceima Bay, Quemado, Ajdir, Cap Quilates, Ras Kebdana
                    35.245 to -3.930, 35.230 to -3.850, 35.280 to -3.670, 35.200 to -3.400, 35.160 to -3.050,
                    // Cap des Trois Fourches, Melilla border, Nador Marchica Lagoon
                    35.435 to -2.975, 35.360 to -2.950, 35.300 to -2.950, 35.170 to -2.930, 35.110 to -2.730,
                    // Ras El Ma (Cap de l'Eau), Saidia beach, Kiss River mouth
                    35.140 to -2.420, 35.130 to -2.350, 35.110 to -2.230, 35.085 to -2.200,
                    // Eastern border: Ahfir, Beni Drar, Oujda, Touissit, Sidi Boubker, Jerada
                    34.950 to -2.100, 34.820 to -1.980, 34.680 to -1.910, 34.450 to -1.880, 34.300 to -1.950,
                    // El Aioun Sidi Mellouk south, Ain Beni Mathar, Tendrara, Bouarfa, Mengoub
                    34.150 to -2.000, 34.008 to -2.025, 33.500 to -2.050, 33.000 to -1.900, 32.530 to -1.950, 32.300 to -1.600,
                    // Figuig Oasis loop & frontier (Zenaga, El Maiz, Jbel Grouz, Ich)
                    32.120 to -1.230, 32.050 to -1.450, 31.850 to -2.000, 31.800 to -2.300, 31.500 to -3.000,
                    // Erg Chebbi, Merzouga, Rissani, Taouz, Ouzina, Ramlia
                    31.100 to -3.980, 30.900 to -4.000, 30.500 to -4.500, 30.200 to -5.100,
                    // Zagora, Tagounite, M'Hamid El Ghizlane, Erg Chigaga, Jbel Bani
                    29.800 to -5.720, 29.600 to -6.100, 29.750 to -6.400,
                    // Foum Zguid, Tata, Akka, Assa-Zag, Aouinet Torkoz
                    30.080 to -6.870, 29.500 to -6.900, 29.200 to -7.900, 28.900 to -8.300, 28.400 to -8.670, 28.200 to -8.670,
                    // Tindouf frontier & Northern Sahara Parallel (27°40' N)
                    27.670 to -8.670, 27.670 to -9.500, 27.670 to -10.000, 27.670 to -11.000, 27.670 to -12.000,
                    // Eastern Sahara Meridian (12° W) straight line southwards
                    26.000 to -12.000, 25.000 to -12.000, 24.000 to -12.000, 23.000 to -12.000, 22.000 to -12.000, 21.340 to -12.000,
                    // Southern Sahara border to Atlantic Ocean (21°20' N)
                    21.340 to -13.000, 21.340 to -14.000, 21.340 to -15.000, 21.340 to -16.000, 21.340 to -16.950,
                    // Guerguerat, Ras Nouadhibou & Lagouira Peninsula (Cap Blanc)
                    21.430 to -16.960, 21.340 to -17.000, 21.000 to -17.050, 20.830 to -17.090, 20.770 to -17.050, 20.850 to -17.030,
                    // Atlantic Coastline heading North: Baie de Cintra, Cap Barbas, Cap Corveiro
                    21.800 to -16.900, 22.150 to -16.820, 22.300 to -16.760, 22.500 to -16.600,
                    // Dakhla Peninsula & Rio de Oro Bay (Lassarga, Ntireft, Cap Dunford)
                    22.980 to -16.220, 23.600 to -15.950, 23.700 to -15.900, 23.720 to -15.930, 23.900 to -15.750, 24.550 to -15.220,
                    // Cap Boujdour, Chalouk, Laayoune Plage (Foum El Oued)
                    25.550 to -14.680, 26.125 to -14.490, 26.500 to -14.100, 26.750 to -13.850, 27.150 to -13.410,
                    // Tarfaya (Cap Juby), Akhfennir, Naila Lagoon National Park, Tan-Tan Plage (El Ouatia)
                    27.500 to -13.200, 27.940 to -12.920, 28.020 to -12.220, 28.300 to -11.800, 28.500 to -11.350, 28.670 to -11.150, 28.750 to -11.050,
                    // Sidi Ifni, Legzira, Mirleft, Aglou, Tiznit coast, Oued Massa mouth
                    29.380 to -10.180, 29.450 to -10.110, 29.580 to -10.040, 29.800 to -9.830, 30.050 to -9.750, 30.150 to -9.680,
                    // Agadir Bay, Anza, Aourir, Taghazout, Cap Ghir, Tamri, Imsouane, Tafedna
                    30.420 to -9.600, 30.480 to -9.650, 30.550 to -9.720, 30.650 to -9.880, 30.700 to -9.860, 30.840 to -9.820, 31.100 to -9.800,
                    // Essaouira (Mogador), Cap Sim, Moulay Bouzerktoun
                    31.390 to -9.850, 31.510 to -9.770, 31.650 to -9.680,
                    // Cap Beddouza, Safi, Oualidia Lagoon, Oulad Ghanem
                    32.100 to -9.350, 32.320 to -9.260, 32.550 to -9.280, 32.730 to -9.040, 33.000 to -8.700,
                    // Sidi Bouzid, El Jadida (Mazagan), Azemmour (Oum Er-Rbia mouth), Sidi Rahal, Dar Bouazza
                    33.250 to -8.510, 33.320 to -8.310, 33.480 to -7.950, 33.550 to -7.800,
                    // Casablanca (Ain Diab, Corniche, Hassan II, Port), Mohammedia
                    33.600 to -7.650, 33.620 to -7.480, 33.720 to -7.400,
                    // Bouznika, Skhirat, Temara, Harhoura, Rabat & Sale (Bouregreg mouth)
                    33.800 to -7.150, 33.850 to -7.150, 33.950 to -6.950, 34.030 to -6.830,
                    // Plage des Nations, Mehdia & Kenitra (Sebou mouth), Sidi Taibi, Moulay Bousselham Lagoon
                    34.120 to -6.750, 34.260 to -6.670, 34.500 to -6.500, 34.880 to -6.290,
                    // Larache (Loukkos mouth), Asilah, Sidi Kacem, back to Cap Spartel
            ...
            run {
                val psPoints = pts(
                    33.10 to 35.15, 32.80 to 35.00, 32.40 to 34.90, 32.08 to 34.78,
                    31.80 to 34.65, 31.50 to 34.45, 31.25 to 34.25, 31.25 to 34.80,
                    31.50 to 35.00, 31.75 to 35.20, 32.00 to 35.25, 32.22 to 35.26,
                    32.46 to 35.30, 32.70 to 35.50, 33.10 to 35.15
                )
                WorldCountryBorder(
                    id = "ps",
                    iso3 = "PSE",
