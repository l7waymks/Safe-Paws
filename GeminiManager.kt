    ...
    fun getLocalExpertReply(question: String): String {
        ...
        return when {
            ...
            q.contains("ماء") || q.contains("شرب") || q.contains("عطش") || q.contains("جفاف") || q.contains("كلى") || q.contains("مسالك") ->
                ...
                "• في حال صعوبة التبول أو حبس البول تماماً، يستدعي ذلك التوجه للعيادة البيطرية فوراً."
            ...
            // 16. الإسعافات الأولية والجروح والكسور
            q.contains("جرح") || q.contains("نزيف") || q.contains("كسر") || q.contains("عرج") || q.contains("حادث") || q.contains("دم") || q.contains("بلع") ->
                "🩹 **الإسعافات الأولية السريعة:**\n" +
                "• **للنزيف:** اضغط بشاش معقم نظيف مباشرة على الجرح لمدة 3 دقائق.\n" +
                "• **للكسور والعرج:** ضع الأليف بصندوق مبطن بهدوء ولا تحاول تحريك العظم المصاب وتوجه للعيادة البيطرية."
