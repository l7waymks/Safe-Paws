            ...
            Column(
                    ...
                    Column(modifier = Modifier.padding(12.dp)) {
                        ...
                        Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                            Button(
                                ...
                                Text("اتصال بالعيادة", fontSize = 10.sp, fontWeight = FontWeight.Bold)
                            }
                            OutlinedButton(
                                onClick = {},
                                shape = RoundedCornerShape(8.dp),
                ...
                Card(
                    ...
                    Column(modifier = Modifier.padding(12.dp)) {
                        ...
                        Spacer(modifier = Modifier.height(4.dp))
                        Text("رعاية صحية بيطرية على مدار 24 ساعة لجميع الحيوانات الأليفة مع كادر دولي متميز.", fontSize = 12.sp)
                        Spacer(modifier = Modifier.height(8.dp))
                        Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                            Button(
                                onClick = {},
                                ...
                                Text("اتصال بالمستشفى", fontSize = 10.sp, fontWeight = FontWeight.Bold)
                            }
                            OutlinedButton(
                                onClick = {},
                                shape = RoundedCornerShape(8.dp),
